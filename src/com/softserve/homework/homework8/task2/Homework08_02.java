...
public class Homework08_02 {
    // TODO: Create a Student class with an int field that matches the course the student is taking.
    ...
    public static void main(String[] args) throws CloneNotSupportedException {
        Person[] people = {
                new Student("Ivan", "Franko", 32, 121),
                new Student("Oleg", "Holod", 19, 81),
        };

        Student student = (Student) people[0].clone();
        student.setCourse(131);
