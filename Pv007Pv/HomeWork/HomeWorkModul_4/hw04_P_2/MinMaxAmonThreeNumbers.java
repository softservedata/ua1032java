...
public class MinMaxAmonThreeNumbers {
    ...
    static void minAndMax(int a , int b, int c) {
        if ((a < b ) && (a < c)) { System.out.println("Minimum values: " + a);}
        else if ((b < a ) && (b < c)) { System.out.println("Minimum values: " + b);}
        else if ((c < a ) && (c < b)) { System.out.println("Minimum values: " + c);}

        if ((a > b ) && (a > c)) { System.out.println("Maximum values: " + a);}
        else if ((b > a ) && (b > c)) { System.out.println("Maximum values: " + b);}
        else if ((c > a ) && (c > b)) { System.out.println("Maximum values: " + c);}
    }
